...
//   const { setStep } = useGetStartedContext()
...
//         <hr />
//         <button className="bg-insta-primary text-white w-full py-2 rounded-full shadow-md font-medium" onClick={handleNext}>Continue</button>
